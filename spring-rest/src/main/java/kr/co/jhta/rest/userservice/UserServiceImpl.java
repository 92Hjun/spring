...
public class UserServiceImpl implements UserService{
	...
	static {
		...
		db.add(new User(counter.getAndIncrement(), "hong", "zxcv1234", "홍길동", "010-1234-1234", "hong@gamil.net"));
		db.add(new User(counter.getAndIncrement(), "lee", "zxcv1234", "이순신", "010-3333-4444", "lee@gamil.net"));
	}
