 ...
 * Generated at: 2017-04-27 05:27:33 UTC
...
public final class profpwdcheck_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("$(function() {\r\n");
      out.write("\tif($(\"input #pwdConfirm\")) {\r\n");
      out.write("\t\tif($(\"#pwdConfirm\").val() == (\"false\")){\r\n");
      out.write("\t\t\talert(\"비밀번호가 올바르지 않습니다.\");\r\n");
      out.write("\t\t\t$(\"#board-Pwd\").focus();\r\n");
      out.write("\t\t\tconsole.log($(\"#pwdConfirm\").val())\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tif($(\"#pwdConfirm\").val() == (\"true\")) {\r\n");
      out.write("\t\t\talert(\"비밀번호가 변경되었습니다.\");\r\n");
      out.write("\t\t\tconsole.log($(\"#pwdConfirm\").val())\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t$(\"#RepwdCheck\").keyup(function(event) {\r\n");
      out.write("\t\tif($(\"#Repwd\").val() == $(\"#RepwdCheck\").val()) {\r\n");
      out.write("\t\t\t$(\"#RepwdCheckSpan\").empty();\r\n");
      out.write("\t\t\t$(\"#RepwdCheckSpan\").append(\"<font color='blue' id='Remessage'>새 비밀번호와 일치합니다.</font>\");\r\n");
      out.write("\t\t\t$(\"#submit-btn\").removeAttr(\"disabled\");\r\n");
      out.write("\t\t} else {\r\n");
      out.write("\t\t\t$(\"#RepwdCheckSpan\").empty();\r\n");
      out.write("\t\t\t$(\"#RepwdCheckSpan\").append(\"<font color='red' id='Remessage'>새 비밀번호와 일치하지 않습니다.</font>\");\r\n");
      out.write("\t\t\t$(\"#submit-btn\").attr(\"disabled\", \"disabled\");\r\n");
      out.write("\t\t}\r\n");
      out.write("\t});\r\n");
      out.write("\t\r\n");
      ...
      out.write("\" id=\"pwdConfirm\"/>\r\n");
      out.write("    <div class=\"row text-right\">\r\n");
      out.write("         홈\r\n");
      out.write("      </div>\r\n");
      out.write("      <div class=\"row\">\r\n");
      out.write("         <h4><span class=\"glyphicon glyphicon-th-list\"></span> 비밀번호 변경</h4>\r\n");
      out.write("         <hr style=\"border:solid 0.5px #2C7BB5;\">\r\n");
      out.write("      </div>\r\n");
      out.write("      <div class=\"row\">\r\n");
      out.write("\t\t<div style=\"padding-top: 2px; text-align: center;  border:1px solid gray;\">\r\n");
      out.write("\t\t\t<form action=\"/jhta/prof/profPwdCheck\" method=\"POST\">\r\n");
      out.write("\t\t\t\t<h2 style=\"padding-top: 30px;\"><strong>비밀번호 변경</strong></h2><br />\r\n");
      out.write("\t\t\t\t<hr />\r\n");
      out.write("\t\t\t\t<p style=\"font-size : 15px;\">\r\n");
      out.write("\t\t\t\t\t<strong style=\"font-size: large; padding-bottom: 5px;\">회원님의 소중한 개인정보를 안전하게 보호하기 위해</strong><br />\r\n");
      out.write("\t\t\t\t\t<span style=\"color:#008bcc;\">\r\n");
      out.write("\t\t\t\t\t기존의 비밀번호를 입력해주세요.</span> <br />\r\n");
      out.write("\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t<hr />\r\n");
      out.write("\t\t\t\t<div class=\"text-left\">\r\n");
      out.write("\t\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t\t<label for=\"profPwd\" style=\"padding-left: 30px; padding-right: 28px;\">현재 비밀번호</label> \r\n");
      out.write("\t\t\t\t\t\t<input type=\"password\" id=\"profPwd\" name=\"profPwd\"/>\t\r\n");
      out.write("\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t\t<label for=\"Repwd\" style=\"padding-left: 30px; padding-right: 42px;\">새 비밀번호</label>\r\n");
      out.write("\t\t\t\t\t\t<input type=\"password\" id=\"Repwd\" name=\"Repwd\"/>\t\r\n");
      out.write("\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t\t<label for=\"RepwdCheck\" style=\"padding-left: 30px; padding-right: 10px;\">새 비밀번호 확인</label>\r\n");
      out.write("\t\t\t\t\t\t<input type=\"password\" id=\"RepwdCheck\"/> <span id=\"RepwdCheckSpan\"></span>\r\n");
      out.write("\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div style=\"padding-top: 2px; text-align:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      center;\">\r\n");
      out.write("\t\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t\t<button id=\"submit-btn\" type=\"submit\" class=\"btn btn-info\" disabled=\"disabled\">확인</button>\r\n");
      out.write("\t\t\t\t\t\t<a href=\"/jhta/prof/main\" class=\"btn btn-danger\">취소</a>\r\n");
      out.write("\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\t\t</div>\r\n");
