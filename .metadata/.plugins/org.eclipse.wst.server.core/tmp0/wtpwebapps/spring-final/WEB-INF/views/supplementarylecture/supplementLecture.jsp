...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<h4>&nbsp;&nbsp;&nbsp;휴강 신청</h4>
			<div class="col-sm-1">
				<a href="pageRedirect.do"><i class="material-icons">restore_page</i></a>
			</div>
		...
		<div class="row" style="margin-bottom: 15px;">
			<div class="col-sm-12">
				<div class="btn-group">
					<a href="admin/adminrecmessagebox" class="btn btn-info">받은쪽지</a> <a
						href="admin/adminsendmessagebox" class="btn btn-info">보낸쪽지</a> <a
						href="admin/adminmessageform" class="btn btn-info">쪽지쓰기</a>
				</div>
			</div>
		</div>
		<div class="row">
